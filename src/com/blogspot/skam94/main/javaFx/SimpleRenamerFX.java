 ...
 */
package com.blogspot.skam94.main.javaFx;

import com.blogspot.skam94.main.datatypes.FileItem;
import com.blogspot.skam94.main.logic.Processor;
...
//        mainPane.setCenter(filesList);
        ...
        Button renameButton=new Button("com.blogspot.skam94.main.logic.Rename");
...
//                    Platform.runLater(()-> db.getFiles().stream().forEach(file->processor.addFile(file)));
        ...
        mainStage.setTitle("Simple Renamer - skam94.blogspot.com");
